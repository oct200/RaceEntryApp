...
public class ChatServerImpl : IService
{
    ...
    public List<model.ORMModel.Cursa> GetAllCurse()
    {
        throw new NotImplementedException();
    }

    public List<model.ORMModel.Cursa> GetAllCurseByCapMotor(int cap)
    {
        throw new NotImplementedException();
    }

    public List<model.ORMModel.Participant> GetAllParticipanti()
    {
        throw new NotImplementedException();
    }

    public List<model.ORMModel.Participant> GetAllParticipantiByEchipa(string echipa)
    {
        throw new NotImplementedException();
    }
    ...
    public List<model.ORMModel.Cursa> GetCurseForParticipant(model.ORMModel.Participant participant)
    {
        throw new NotImplementedException();
    }
    ...
    public void Logout(model.ORMModel.User user)
    {
        throw new NotImplementedException();
    }

    public model.ORMModel.User UserExists(string username, string pass, IClientObserver client)
    {
        throw new NotImplementedException();
    }
}