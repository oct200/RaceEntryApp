...
public class Principal implements IClientObserver{
    ...
    private void buttonLogOut_Click() {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(StartClient.class.getResource("autentificare.fxml"));
    ...
    private void buttonInscrieParticipant_Click() {
        try {
            Stage primaryStage = (Stage) comboBoxEchipe.getScene().getWindow();
            FXMLLoader fxmlLoader = new FXMLLoader(StartClient.class.getResource("adaugareParticipant.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            AdaugareParticipant comntroller = fxmlLoader.getController();
            comntroller.setServiceAplicatie(proxy);
            primaryStage.setScene(scene);
            primaryStage.show();
        }
